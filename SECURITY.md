...
[Report a vulnerability](https://github.com/PRECISE-research/cworsey-pizzolato-emg-norm/security/advisories/new), or the **Security** tab on this repository.
Private reports are visible only to the maintainers. You need to be signed in
to GitHub to open the form.
